...
extern unsigned long DEFAULT_DigitsArraySize;
...
public:
    ...
    friend inline std::istream& operator >> (std::istream& cin, TLargeFloat& Value){std::string tmp;cin>>tmp;Value.sToLargeFloat(tmp);}
